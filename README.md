...
A tiny static site that hosts reusable [Claude Code](https://claude.com/claude-code) skills for download and one-line restore.
...
```
claude-skill-hub/
├── index.html       # reads skills.json, renders a card per skill
